...
# Author: Abdallah-X1L                              #
# Country: Egypt                                    #
# Email: abdallahhusseinx1l@gmail.com               #
# Organization: Avengers                            #
# Website: egyptianscom.yooco.org                   #
# Other Website: abdallahx1l.site123.com            #
#####################################################
#                                                   #
#                                                   #
#           Copyright © 2018 AbdallahX1L            #
#                                                   #
#                                                   #
#####################################################
...
def main():
    try:
        ...
        print(wcolors.color.YELLOW + "[*] Thank You For Using X1L Framework =)" + wcolors.color.ENDC)
def start():
    header.main_header()
    menu.main_info()
    main()
